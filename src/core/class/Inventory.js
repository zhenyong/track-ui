...
Tk.Inventory.prototype = {
    ...
    getNamesByExpression: function (expression, exclude, accumulate) {
        var me = this,
            ...
            names = [],
            expressions = Tk.isString(expression) ? [expression] : expression,
    ...
    selectMethod: function (excludes, fn, scope) {
        ...
        return function (include) {
            var args = Tk.Array.slice(arguments, 1);
     ...
     * @return {Tk.Inventory} this
     * @method
     */
    setPath: Tk.Function.flexSetter(function (name, path) {
        var me = this;
